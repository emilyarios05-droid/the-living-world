...
import type { PlayerCharacter } from '../player/character.js';

export type WorldId = string & { readonly __brand: 'WorldId' };
export type EntityId = string & { readonly __brand: 'EntityId' };
export type IsoTimestamp = string & { readonly __brand: 'IsoTimestamp' };

export interface WorldClock { readonly worldId: WorldId; readonly startedAtReal: IsoTimestamp; readonly lastAdvancedAtReal: IsoTimestamp; readonly worldTimeMs: number; readonly paused: boolean; }
export interface WorldMetadata { readonly id: WorldId; readonly ownerAccountId: string; readonly createdAt: IsoTimestamp; readonly updatedAt: IsoTimestamp; readonly status: 'active' | 'dead' | 'deleted'; }
...
export type DomainEvent =
  ...
  | { readonly type: 'PLAYER_CHARACTER_CREATED'; readonly worldId: WorldId; readonly characterId: EntityId; readonly at: IsoTimestamp }
